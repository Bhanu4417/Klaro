      ...
      {src && (
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 sm:p-8">
          ...
          <motion.div
            ...
            className="relative z-[121] w-full max-w-[560px] rounded-[24px] bg-[#FCFCFB] border border-white/80 shadow-[0_24px_60px_rgba(0,0,0,0.32),inset_0_1px_1px_rgba(255,255,255,0.95)] p-2.5 space-y-2.5"
          >
            {/* Header row */}
