...
interface WelcomeViewProps {
  onSelectSocial: (provider: SocialProvider) => void;
  onSelectEmail: () => void;
  onDirectSignIn: () => void;
  onOfficerLogin: () => void;
  isLoadingSocial?: SocialProvider | null;
}
    ...
    <div className="w-full space-y-4 text-center">
      ...
      <div className="space-y-2.5">
        <SocialAuthButton
          ...
          isLoading={isLoadingSocial === "google"}
          disabled={Boolean(isLoadingSocial)}
        />
        <SocialAuthButton
          provider="github"
          onClick={() => onSelectSocial("github")}
          isLoading={isLoadingSocial === "github"}
          disabled={Boolean(isLoadingSocial)}
        />
      </div>
      ...
      <div className="pt-1.5 space-y-3">
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            className="w-4 h-4 text-zinc-800 group-hover:scale-105 transition-transform shrink-0"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
          >
          ...
          <span className="text-[11px] font-mono text-zinc-400 group-hover:translate-x-0.5 transition-transform">→</span>
        </button>
      </div>
      ...
      <div className="pt-3 border-t border-zinc-100">
        <p className="text-[11px] leading-relaxed text-zinc-400">
          ...
          <a
            ...
            className="text-zinc-600 underline underline-offset-2 decoration-[#94EC40] decoration-1.5 hover:decoration-2 hover:text-[#346415] transition-colors font-medium"
          >
            Terms of Service
          </a>{" "}
          and{" "}
